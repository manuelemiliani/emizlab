        ...
        sidebarContainer.innerHTML = `
            <a href="noticia.html" class="sidebar-ad-card" title="Anuncio 1">
                ...
                <div class="sidebar-ad-content">
                    ...
                    <div>
                        <strong style="font-size: 0.85rem; color: var(--dark); display: block;">¡Conoce Más Aquí!</strong>
                        <p style="font-size: 0.78rem; margin: 0; color: var(--text-muted);">Espacio exclusivo para destacar tu marca.</p>
                    </div>
                </div>
            </a>
            ...
            <a href="noticia.html" class="sidebar-ad-card" title="Anuncio 2">
                <div class="sidebar-ad-content">
                    ...
                    <div>
                        <strong style="font-size: 0.85rem; color: var(--dark); display: block;">¡Oferta Especial!</strong>
                        <p style="font-size: 0.78rem; margin: 0; color: var(--text-muted);">Descubre nuestros servicios y promociones.</p>
                    </div>
                </div>
            </a>
    ...
    if (inArticleAdContainer) {
        inArticleAdContainer.innerHTML = `
            <div class="in-article-ad-box">
                ...
                <a href="noticia.html" class="ad-banner-250" title="¡Servicios Técnicos!">
